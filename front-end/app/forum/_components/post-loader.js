  ...
  return (
    <div className="post-home d-flex flex-column gap-1 px-4 py-3 rounded-3 shadow-forum bg-pure-white card-border">
      ...
      >
        ...
        {/* 相片 */}
        <rect x="0" y="88" rx="16" ry="16" width="131" height="130" />
        <rect x="139" y="88" rx="16" ry="16" width="131" height="130" />
        <rect x="276" y="88" rx="16" ry="16" width="131" height="130" />
        <rect x="414" y="88" rx="16" ry="16" width="131" height="130" />
        <rect x="552" y="88" rx="16" ry="16" width="131" height="130" />
        {/* evaluate */}
